    ...
    <div class="container">
        <div class="row justify-content-between">         
            <div class="col-2 align-self-start">				
                <img class="align-text-center img-fluid" src="assets/img/logo_icon.png" />               
            </div>				
            <div class="col-4 align-self-center d-flex align-items-center flex-column">
                <h4>Contact Us</h4>
                <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+918296060283"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-success" href="mailto:201910101286@presidencyuniversity.in"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
            </div>				
            <div class="pull-right col-12 col-md-4 align-self-center">
